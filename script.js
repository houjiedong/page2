    ...
    submitOptionsButton.addEventListener('click', function () {
        ...
        options.forEach(option => {
            ...
            optionDiv.innerHTML = `<h4>${option}</h4>
                <label>实用性评分：<input type="number" id="${option}-1" min="1" max="8"></label><br>
                <label>质量评分：<input type="number" id="${option}-2" min="1" max="8"></label><br>
                <label>耐用性评分：<input type="number" id="${option}-3" min="1" max="8"></label><br>
                <label>性价比评分：<input type="number" id="${option}-4" min="1" max="8"></label><br>
            `;
